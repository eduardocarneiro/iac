...
read -p "What is the IP to eth0(GW Net): " vmGwIp
...
#
# Start ansible
#ansible-playbook -i hosts playbook-createvm-gw-fw-router.yaml -e "ext_resource_pool='${resourcePool}' ext_vc_folder='${vcenterFolder}' ext_vm_network='${vcenterNetwork}' ext_vm_name='${vmName}' ext_vm_gw_ip='${vmGwIp}' ext_vm_ip='${vmIP}' ext_vm_gw='${vmGW}' ext_vm_dns1='${vmDNS1}' ext_vm_dns_search='${vmDnsSearch}'"
