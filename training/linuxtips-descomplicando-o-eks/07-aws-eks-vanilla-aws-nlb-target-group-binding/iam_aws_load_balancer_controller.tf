...
data "aws_iam_policy_document" "aws_lb_role" {
  statement {
    ...
    condition {
      ...
      values   = ["system:serviceaccount:aws-lb-controller:aws-load-balancer-controller"]
    }
...
resource "aws_iam_role" "aws_lb_controller" {
  ...
  name               = format("%s-aws-load-balancer", var.aws_lb_policy_name)
}
...
resource "aws_iam_policy" "aws_lb_policy" {
  name        = format("%s-aws-load-balancer", var.aws_lb_policy_name)
  path        = "/"
  description = var.aws_lb_policy_name
